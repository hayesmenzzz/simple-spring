...
public class TblLeaveApplyProcessBean {
	 ...
	 */
	public TblLeaveApplyProcessBean() {
		super();
	}
	public TblLeaveApplyProcessBean(int id, String processKey, String processOrderId, String businessId, String taskId,
